...
//   const pageSize: any = process.env.PAGINATION_LIMIT;
...
const createProduct = asyncHandler(async (req: AuthRequest, res: Response) => {
  const product = new Product({
    name: "Sample name",
    price: 0,
    user: req.user?._id, // req.user is now typed!
